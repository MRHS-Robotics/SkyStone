...
import java.util.LinkedList;
    ...
    @Autonomous(name="BE2019_AutoBrick", group="Iterative Opmode")
    public class BE2019_AutoBrick extends AutoAbstract
    {
        void setPhases(LinkedList<AutonomousPhase> phaseList) {
            //phaseList.add(new ForwardDurationPhase(3000, 0.5, false));
            phaseList.add(new ForwardDurationPhase(300, -0.5, false));
            phaseList.add(new TurnDurationPhase(3450, 0.5));
            //phaseList.add(new TurnDurationPhase(2000, 0.5));
            phaseList.add(new ForwardDurationPhase(3500, 0.5, true));
